...
const NgoChat = () => {
  ...
  const [chats, setChats] = useState([
    {
        image: pizza,
      contactName: "PizzaHut",
      messages: [
        { text: "Greetings", sender: "contact" },
        { text: "We are interested in donating for social impact campaign started by your NGO", sender: "contact" },
        { text: "About that we would like to connect with you", sender: "contact" },
    ...
    },
    {
      ...
      messages: [
        { text: "Greetings", sender: "contact" },
        { text: "We have sent you the documents.", sender: "contact" },
      ],
    },
    // {
    //   contactName: "Muskurate Raho",
    //   messages: [
    //     { text: "Hello!", sender: "contact" },
    //     { text: "We are also free on the weekend", sender: "contact" },
    ...
    <>
      <div className="flex h-screen bg-white ">
          ...
          <div className="p-4 space-y-4 h-auto">
            ...
            <div className="relative">
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="absolute left-2.5 top-3 h-4 w-4 text-zinc-500  text-zinc-400"
              >
            ...
            <div className="space-y-1">
              {chats.map((chat, index) => (
                <div
                  key={index}
                  className={` h-16 flex flex-col justify-center rounded-md border text-sm border-gray-400 ${
                    chat === selectedChat
                ...
                >
                  <div className="p-6">
                    <div className="flex gap-2">
                        ...
                        src={chat.image}
                        alt=""/>
                    <h3 className="font-semibold">{chat.contactName}</h3></div>
                    <p className={`text-xs ${
                    chat === selectedChat
                      ? " text-gray-300"
            ...
            <button onClick={()=>{router.push('/dashboard/ngo')}}>
              <svg
                className="w-8 h-8 text-gray-800  text-white"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
        ...
        <section className="flex flex-col w-full">
          ...
          <footer className="bg-gray-300 rounded-lg  border-zinc-700 p-4">
