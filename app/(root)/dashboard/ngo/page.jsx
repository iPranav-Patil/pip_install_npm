  ...
  return (
    <>
      ...
      <div className="grid min-h-screen w-full lg:grid-cols-[280px_1fr]">
        <div className="hidden border-r bg-gray-100/40 lg:block  bg-gray-800/40">
          <div className="flex h-full max-h-screen flex-col gap-2">
            ...
            <div className="flex-1 overflow-auto py-2">
              <nav className="grid items-start px-4 text-sm font-medium">
                <Link
                  className="flex items-center gap-4 rounded-lg px-3 py-2 text-gray-900 transition-all hover:text-gray-900  text-gray-400  hover:text-gray-50"
                  href={"/dashbaord/ngo"}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <Link
                  className="flex items-center gap-3 rounded-lg  px-3 py-2 text-gray-900  transition-all hover:text-gray-900  bg-gray-800  text-gray-50  hover:text-gray-50"
                  href={"/chat/ngo"}
                >
                  <svg
                    class="w-5 h-5 text-gray-700  text-white"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                ...
                <Link
                  className="flex items-center gap-3 rounded-lg px-3 py-2 text-gray-900 transition-all hover:text-gray-900  text-gray-400  hover:text-gray-50"
                  href="/raise"
                >
                  <svg
              ...
              >
                <div className="p-6 flex flex-row items-center justify-between pb-2 space-y-0">
                  ...
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="w-4 h-4 text-gray-600  text-gray-400"
                  >
