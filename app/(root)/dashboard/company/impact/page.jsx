...
export default function Impact() {
  return (
    <div className="flex flex-col min-h-screen">
      <header className="flex items-center justify-between p-6 bg-white  bg-gray-800">
        <Link className="flex items-center space-x-2" href={"/dashboard/company"}>
            <svg
              class="w-8 h-8 text-gray-800  text-white"
              aria-hidden="true"
      ...
      <main className="flex-1">
        ...
        <section className="py-12 px-6 bg-gray-50  bg-gray-900">
          <h2 className="text-3xl font-bold text-center mb-6">Testimonials</h2>
          <div className="flex gap-6 justify-center mx-auto">
            <blockquote className="p-6 bg-white rounded-lg shadow  bg-gray-800">
          ...
          <div className="grid gap-6 max-w-3xl mx-auto grid-cols-3">
            <div className="flex flex-col items-center space-y-4">
              <svg
                ...
                className="h-6 w-6 text-gray-500  text-gray-400"
              >
      ...
      <footer className="p-6 bg-white  bg-gray-800">
