              ...
              <div>
                ...
                <div className="flex gap-10">
                  <div className="space-x-4 my-4">
                    ...
                    <Link
                      className="inline-flex h-9 items-center justify-center rounded-md border border-gray-200  bg-white px-4 py-2 text-sm font-medium shadow-sm transition-colors hover:bg-gray-100 hover:text-gray-900 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50  border-gray-800  border-gray-800  bg-gray-950  hover:bg-gray-800  hover:text-gray-50  focus-visible:ring-gray-300"
                      href={"/login/company"}
                    >
                      Login
                    </Link>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container space-y-12 px-4 md:px-6">
            ...
            <div className="mx-auto grid items-start gap-8 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-3">
              ...
              <div className="grid gap-1">
                <svg
                  class="w-10 mb-2 h-10 text-gray-800  text-white"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
